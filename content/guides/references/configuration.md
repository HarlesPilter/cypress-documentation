...
| `supportFile`     | `cypress/support/component.js` or `cypress/support/e2e.js` | Path to file to load before test files load. This file is compiled and bundled. (Pass `false` to disable)                                                                                           |
